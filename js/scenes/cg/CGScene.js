var cgScene, cgSceneStars, cgSceneStars2, cgSteneStars3, cgSceneEarth, cgSceneClouds, cgSceneMoon,
    cgSceneMoonCenter, axisHelper, cgSceneGlow, cgSceneLight, cgSceneSpotLight, cgSceneLight2, cgSceneLightSphere,
    cgSceneDiscover0Gui, cgSceneDiscover1Gui, cgSceneDiscover2Gui, cgSceneDiscover3Gui,
    cloudsTweenRotation, earthTweenRotation,
    moonTweenRotation, moonTweenOrbitRotation;
...
function initCGScene() {
    //set background color, change title and load html content
    renderer.setClearColor(0x000000);
    $('#description').text("Prof. Dr. Stefan Müller");
    $('#page-title').text("COMPUTERGRAFIK");
    $('#content').load("content/cg/cgSceneStart.html");

    //initialise and add the scene.
    ...
    //initialise the light and add it to the scene
    ...
    //initalise the viewable light sphere and add it to the scene light
    ...
    //init spotlight for discover 2 and 3
    ...
    //initalise the center of the moon (for rotation)
    var material = new THREE.MeshBasicMaterial({
        color: 0xffffff,
        transparent: true,
        opacity: 0,
    ...
    //call function for animation initialisiation
...
function resetSpeed() {
    ...
    parameters3.earthRotation = 1;
    parameters3.moonRotation = 1;
    parameters3.orbitSpeed = 1;
 }

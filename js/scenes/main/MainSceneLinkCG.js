var mainSceneLinkCG, mainSceneLinkCGSphere, mainSceneLinkCGText;
var mainSceneLinkCGEarth;
var mainSceneLinkCGClouds;
var mainSceneLinkCGMoon, mainSceneLinkCGMoonCenter;
var hoveredCG = false;
...
function initMainSceneLinkCG() {
  ...
  //Text
  var textCG = new THREE.TextGeometry("COMPUTER GRAPHICS", {
    size: 8,
    height: 2,
    curveSegments: 4,
    font: "helvetiker",
  ...
  mainSceneLinkCGTextVolume.position.set(-1.7 * centerOffset, 0, 0);
  ...
  loader.load("models/stripe.json", function(geometry) {
    ...
    mainSceneLinkCGLine.scale.set(2.1, 0.25, 0.05);

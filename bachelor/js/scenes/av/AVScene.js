...
function avSceneKeyboard(delta, nodww) {
    if (avSceneDiscoverNr === 2) {
        ...
        if (keyboard.pressed('up') || keyboard.pressed('w')) {
            if (!(avSceneDiscover2Lisa.position.y >= 200 && avSceneDiscover2Lisa.rotation.y > -Math.PI * 0.5 && avSceneDiscover2Lisa.rotation.y < Math.PI * 0.5) &&
                !(avSceneDiscover2Lisa.position.y <= -200 && !(avSceneDiscover2Lisa.rotation.y > -Math.PI * 0.5 && avSceneDiscover2Lisa.rotation.y < Math.PI * 0.5)) &&

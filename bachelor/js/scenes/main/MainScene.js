...
function hoverCylinders() {
    ...
    if (intersects.length > 0) {
        ...
        changeCylinderColor(intersects[0].object);
    }
}

function changeCylinderColor(cylinder) {
    cylinder.material = new THREE.MeshLambertMaterial();
}
...
//Laden aller Sprites fuer "Der Studiengang"
function loadAboutSprites() {
    //Alle Sprites fuer den Aufbau des Studiengangs
    ...
    //Sprites fuer Logos der anderen Institute

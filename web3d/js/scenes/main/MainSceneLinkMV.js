...
function initMainSceneLinkMV() {
    ...
    mainSceneLinkMVTextVolume.userData = { animationNr: 3 }
    ...
    mainSceneLinkMVSphere.userData = { sceneNr: 3, animationNr: 3 };
    ...
    mvloader.load("models/upperteeth.json", function(obj) {
        ...
        mvloader2.load("models/lowerteeth.json", function(obj) {
            mainSceneLinkMVLowerTeeth = obj.clone();
...
//this function open and closes the mouth
...
//sets the animation of the mouth back
...
//stops the animation of the mouth
function mainSceneLinkMVAnimateStop() {
    lowerTeethTweenRotationDown.stop();
    lowerTeethTweenRotationUp.stop();
    lowerTeethTweenPositionDown.stop();
    lowerTeethTweenPositionUp.stop();
